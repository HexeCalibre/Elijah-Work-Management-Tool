function changeStatusPunchlist() {
    ...
    var startDateCol = 11; // Start Date column
    var startTimeCol = 12; // Start Time column
    var endDateCol = 13;   // End Date column
    var endTimeCol = 14;   // End Time column
    var lastUpdateCol = 21; // Last Update column
    var taskStatusCol = 18; // Task Status column
  
    const TARGET_SHEET_ID = "937475584"; // The GID of the target sheet
