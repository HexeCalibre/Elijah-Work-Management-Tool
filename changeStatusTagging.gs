function changeStatusTagging() {
    ...
    var startDateCol = 9; // Start Date column
    var startTimeCol = 10; // Start Time column
    var endDateCol = 11;   // End Date column
    var endTimeCol = 12;   // End Time column
    var lastUpdateCol = 20; // Last Update column
    var taskStatusCol = 16; // Task Status column
  
    const TARGET_SHEET_ID = "2130038755"; // The GID of the target sheet
